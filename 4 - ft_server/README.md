...
To test **phpmyadmin** go to `http://localhost/phpmyadmin`  Login: wordpress_user  Password: 12345  (You can find those info in the config file located in srcs/wp-config.php)
